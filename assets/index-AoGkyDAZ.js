...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=Cc.map(e=>{const t=Nc.find(n=>n.id===e.userId),i=zc.filter(n=>n.postId===e.id);return{...e,user:t,comments:i}}),Lc=()=>G.jsxs("section",{className:"App",children:[G.jsx("h1",{className:"App__title",children:"Static list of posts"}),G.jsx("div",{className:"PostList",children:Pc.map(e=>G.jsxs("div",{className:"PostInfo",children:[G.jsxs("div",{className:"PostInfo__header",children:[G.jsx("h3",{className:"PostInfo__title",children:e.title}),G.jsxs("p",{children:[" Posted by ",e.user&&G.jsx("a",{className:"UserInfo",href:`mailto:${e.user.email}`,children:e.user.name})]})]}),G.jsx("p",{className:"PostInfo__body",children:e.body}),G.jsx("hr",{}),e.comments.length===0?G.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):G.jsx("div",{className:"CommentList",children:e.comments.map(t=>G.jsxs("div",{className:"CommentInfo",children:[G.jsxs("div",{className:"CommentInfo__title",children:[G.jsx("strong",{className:"CommentInfo__name",children:t.name})," by ",G.jsx("a",{className:"CommentInfo__email",href:`mailto:${t.email}`,children:t.email})]}),G.jsx("div",{className:"CommentInfo__body",children:t.body})]},t.id))})]},e.id))})]});em(document.getElementById("root")).render(G.jsx(Lc,{}));
